    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="text-dark-emphasis m-0 mb-1">Edit data buku</h2>
                    <p class="text-secondary m-0">Edit data buku yang sudah ada.</p>
                </div>
            </div>
                ...
                <div class="card-body py-4">
                    <form action="{{ route('books.update', $book->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            placeholder="Isi pengarang buku ..."
                            autofocus>
                        @error('pengarang')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="mb-4">
                            ...
                            placeholder="Isi tahun terbit buku ..."
                            autofocus>
                        @error('tahun_terbit')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
